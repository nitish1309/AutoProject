...
public class login {
	...
	public void cancel() {
		...
		Hashtable<String, Object> output2= SeleniumOperations.clickonElement(input1);
	...
	public void usernm(String usernm) throws InterruptedException {
		...
		input4[1]=usernm;
		Hashtable<String, Object> output4= SeleniumOperations.UserDetails(input4);
	...
	public void passw(String pass) {
		...
		Hashtable<String, Object> output5= SeleniumOperations.UserDetails(input5);
	...
	//div[@class='_3E8aIl _3F7kj3']//div//div[1]//div[1]//div[1]//div[1]//div[1]//div[2]//span[1]
